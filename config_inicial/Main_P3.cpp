 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(1.0f,1.0f,-15.0f));
		...
		model = glm::rotate(model, 0.5f, glm::vec3(2.0f, 2.0f, 4.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, 0.5f, glm::vec3(-3.0f, -4.0f, -5.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
